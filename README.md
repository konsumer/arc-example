...
> They didn't mention it in the [AWS example](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/bp-modeling-nosql-B.html), but we will sometimes need to look things up by GS2's SK, so I made a reverse-lookup table for that in GSI3.
